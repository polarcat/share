" pcat.vim based on lessthan.vim -- vim colorscheme
"
" Name:       lessthan
...
let g:colors_name = 'pcat'

hi ifequals guifg=#f0b0b0 guibg=NONE gui=bold ctermfg=24 ctermbg=NONE cterm=bold
hi defined guifg=#8090a0 guibg=NONE gui=NONE ctermfg=24 ctermbg=NONE cterm=bold
...
"" General
hi Normal guibg=#151515 guifg=#bcbcbc gui=NONE ctermbg=0 ctermfg=250
...
hi ErrorMsg guifg=#ffffff guibg=#f06060 gui=NONE
...
hi VertSplit guibg=#101010 guifg=#607080 gui=NONE ctermbg=237 ctermfg=237 cterm=NONE
hi! link TabLine StatusLineNC
hi! link TabLineFill TabLine
hi! link TabLineSel LessThanNormal
hi WildMenu guibg=#a0a010 guifg=#000000 gui=NONE ctermbg=11 ctermfg=16
...
hi MatchParen guibg=#000000 guifg=#60f060 ctermbg=235
hi SpellBad guifg=#ffffff guibg=#f06060 gui=underline ctermfg=darkred ctermbg=NONE cterm=NONE
hi SpellCap guifg=#ffffff guibg=#f06060 gui=NONE ctermfg=darkred ctermbg=NONE cterm=NONE
hi Search guibg=#a0a050 guifg=#0C0C0C gui=NONE
hi ExtraWhitespace guibg=#a05050 ctermbg=red
hi Special guifg=#a0a050 guibg=NONE

" #if 0 block colors
hi LineNr guifg=#505050 guibg=NONE gui=NONE ctermfg=243 ctermbg=234 cterm=NONE
...
"hi Constant guifg=#60c0c0 guibg=NONE gui=NONE ctermfg=green ctermbg=NONE cterm=NONE
hi DefinedName guibg=NONE gui=NONE ctermfg=239 ctermbg=NONE cterm=NONE
hi Constant guifg=#606060 guibg=NONE gui=NONE ctermfg=14 ctermbg=NONE cterm=NONE
hi String guifg=#60c060 gui=NONE ctermfg=246
hi Number guifg=#cccfa1 guibg=NONE gui=NONE ctermfg=24 ctermbg=NONE cterm=NONE
"hi Statement guifg=#90a0b0 gui=bold ctermfg=243 cterm=bold
hi Statement guifg=#909070 gui=bold ctermfg=243 cterm=bold
hi Identifier guifg=#d0d0a0 guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
